	...
	if (delegatesToInvoke != NULL)
	{
		...
		for (il2cpp_array_size_t i = 0; i < length; i++)
		{
			...
			if (currentDelegate->get_m_target_2() != NULL && ___methodIsStatic)
			{
				...
				((FunctionPointerType)currentDelegate->get_method_ptr_0())(NULL,currentDelegate->get_m_target_2(),___source0, ___message1,(RuntimeMethod*)(currentDelegate->get_method_3()));
			}
			else if (currentDelegate->get_m_target_2() != NULL || ___methodIsStatic)
			{
				...
				((FunctionPointerType)currentDelegate->get_method_ptr_0())(currentDelegate->get_m_target_2(),___source0, ___message1,(RuntimeMethod*)(currentDelegate->get_method_3()));
			}
			else
			{
				typedef void (*FunctionPointerType) (void* __this, String_t* ___message1, const RuntimeMethod* method);
				((FunctionPointerType)currentDelegate->get_method_ptr_0())(___source0, ___message1,(RuntimeMethod*)(currentDelegate->get_method_3()));
			}
		}
	}
	else
	...
	if (delegatesToInvoke != NULL)
	{
		...
		for (il2cpp_array_size_t i = 0; i < length; i++)
		{
			...
			if (currentDelegate->get_m_target_2() != NULL && ___methodIsStatic)
			{
				...
				((FunctionPointerType)currentDelegate->get_method_ptr_0())(NULL,currentDelegate->get_m_target_2(),___source0,(RuntimeMethod*)(currentDelegate->get_method_3()));
			}
			else if (currentDelegate->get_m_target_2() != NULL || ___methodIsStatic)
			{
				typedef void (*FunctionPointerType) (void* __this, VideoPlayer_t10059812 * ___source0, const RuntimeMethod* method);
				((FunctionPointerType)currentDelegate->get_method_ptr_0())(currentDelegate->get_m_target_2(),___source0,(RuntimeMethod*)(currentDelegate->get_method_3()));
			}
			else
			{
				typedef void (*FunctionPointerType) (void* __this, const RuntimeMethod* method);
				((FunctionPointerType)currentDelegate->get_method_ptr_0())(___source0,(RuntimeMethod*)(currentDelegate->get_method_3()));
			}
		}
	}
	else
	...
	if (delegatesToInvoke != NULL)
	{
		...
		for (il2cpp_array_size_t i = 0; i < length; i++)
		{
			...
			if (currentDelegate->get_m_target_2() != NULL && ___methodIsStatic)
			{
				...
				((FunctionPointerType)currentDelegate->get_method_ptr_0())(NULL,currentDelegate->get_m_target_2(),___source0, ___frameIdx1,(RuntimeMethod*)(currentDelegate->get_method_3()));
			}
			else if (currentDelegate->get_m_target_2() != NULL || ___methodIsStatic)
			{
				...
				((FunctionPointerType)currentDelegate->get_method_ptr_0())(currentDelegate->get_m_target_2(),___source0, ___frameIdx1,(RuntimeMethod*)(currentDelegate->get_method_3()));
			}
			else
			{
				typedef void (*FunctionPointerType) (void* __this, int64_t ___frameIdx1, const RuntimeMethod* method);
				((FunctionPointerType)currentDelegate->get_method_ptr_0())(___source0, ___frameIdx1,(RuntimeMethod*)(currentDelegate->get_method_3()));
			}
		}
	}
	else
	...
	if (delegatesToInvoke != NULL)
	{
		...
		for (il2cpp_array_size_t i = 0; i < length; i++)
		{
			...
			if (currentDelegate->get_m_target_2() != NULL && ___methodIsStatic)
			{
				...
				((FunctionPointerType)currentDelegate->get_method_ptr_0())(NULL,currentDelegate->get_m_target_2(),___source0, ___seconds1,(RuntimeMethod*)(currentDelegate->get_method_3()));
			}
			else if (currentDelegate->get_m_target_2() != NULL || ___methodIsStatic)
			{
				...
				((FunctionPointerType)currentDelegate->get_method_ptr_0())(currentDelegate->get_m_target_2(),___source0, ___seconds1,(RuntimeMethod*)(currentDelegate->get_method_3()));
			}
			else
			{
				typedef void (*FunctionPointerType) (void* __this, double ___seconds1, const RuntimeMethod* method);
				((FunctionPointerType)currentDelegate->get_method_ptr_0())(___source0, ___seconds1,(RuntimeMethod*)(currentDelegate->get_method_3()));
			}
		}
	}
	else
